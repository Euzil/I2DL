...
class MyPytorchModel(nn.Module):
    ...
    def __init__(self, hparams):
        ...
        # Calculate input size for a 32x32 RGB image
        ...
        self.model = nn.Sequential(
            ...
            nn.BatchNorm1d(self.hparams["n_hidden"] // 2),
            nn.ReLU(),
            nn.Dropout(0.4),
            
            nn.Linear(self.hparams["n_hidden"] // 2, self.hparams["num_classes"])
        )
    ...
    def configure_optimizers(self):
        ...
        # Using Adam optimizer with learning rate from hyperparameters
        # and weight decay for regularization
